...
#ifndef PROJECT_TRACKOBJECT_H
#define PROJECT_TRACKOBJECT_H
...
class TrackObject
{
  ...
  protected:
    ...
    //Declaring And Instantiating A 1x3 Array To Hold The Various Camera Properties .
    //[Camera Speed, Dead Zone, SpeedUp Factor]
    double cameraProperties[3] = {0.10, 120, 0.002};
  ...
  public:
     ...
     */
    explicit TrackObject(string droneID, string window, int hsv[]);
